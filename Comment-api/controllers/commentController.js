...
exports.createComment = async (req, res) => {
    try {
        ...
        const Comment = req.connection.models[modelsMap.Comment.modelName]; // Modèle injecté dynamiquement
...
exports.getAllComments = async (req, res) => {
    try {
        const Comment = req.connection.models[modelsMap.Comment.modelName];
